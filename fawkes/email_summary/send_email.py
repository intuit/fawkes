...
def send_email_helper(from_email_address, to_email, subject, html, sendgrid_api_key):
    message = Mail(
    ...
    try:
        ...
        logging.error(logs.UNABLE_TO_SEND_EMAIL, e)
...
def send_email(fawkes_config_file=constants.FAWKES_CONFIG_FILE):
    ...
    for app_config_file in fawkes_config.apps:
        ...
        for email_id in app_config.email_config.email_list:
            send_email_helper(
                app_config.email_config.sender_email_address,
                email_id,
